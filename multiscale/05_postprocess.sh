...
tmp="tmp_cg_sample"
perl ../scripts/dumptools.pl -p 1 -p 2 -o $tmp ${cg_dump/.dump/}_f*dump
...
backmap_legacy -t $plga/lac.xyz -t $plga/gly.xyz -t $wat/tip4p.xyz \
...
moltemplate.sh -overlay-bonds -overlay-angles -overlay-dihedrals -overlay-impropers -pdb $output.pdb $lt_input
